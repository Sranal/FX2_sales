...
//          項目を「0」にしてください。（表示したい場合は「1」にします。）
  ...
  cdl_keyname  = 'countdown20250919'; // サイト識別ID。サイト毎に割り当てる。
  cdl_expireday   = '10';   			// ●日後までのカウントダウン
...
//         にしてください。（表示したい場合は「1」にします。）
 ...
 lmo_location = 'https://hcollege.jp/le-n/hc/any72/'; // カウントダウン終了時の転送先（../fin）等urlをいれてください。空の場合は文言表示になります。
